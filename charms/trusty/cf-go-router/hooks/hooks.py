...
def emit_router_config():
    ...
    config_items = ['nats_user', 'nats_password', 'nats_port', 'nats_address',
                    'router_port', 'router_status_port', 'router_status_user',
...
def install():
    ...
    #fix it by deleting 'src' directory before. This won't allow
    # to redeploy to an existing machine
    os.chdir(CF_DIR + '/src/github.com/cloudfoundry')
    # TODO: check if repo already exists
    # CAUSES ERROR fatal: destination path 'gorouter' already exists
